...
export const metadata: Metadata = {
  title: "Medical Cannabis Treatment | Licensed Providers",
  description: "Licensed medical cannabis provider offering evidence-based treatment for chronic pain, anxiety, and other medical conditions with physician supervision.",
  keywords: "medical cannabis, cannabis treatment, licensed physician, medical marijuana, chronic pain relief, healthcare",
  metadataBase: new URL("https://medcannabis.com"),
  alternates: {
    canonical: "https://medcannabis.com"
  },
  openGraph: {
    title: "Medical Cannabis Care For Better Health",
    description: "Professional cannabis products prescribed and monitored by licensed healthcare providers.",
    type: "website",
    siteName: "MedCannabis",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764082191895-3p7290pz.jpg",
        alt: "Medical Cannabis Care"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "Medical Cannabis Treatment | MedCannabis",
    description: "Licensed medical cannabis care with physician supervision",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764082191895-3p7290pz.jpg"]
  },
  robots: {
    index: true,
    follow: true
